...
const TABS = [
  ...
  },
  {
    ...
    label: "Tasks",
    icon: FileText,
    description: "Create tasks with all available fields",
    columns: ["projectKey", "title", "description", "priority", "type", "category", "dueDate", "estimatedHours", "storyPoints", "assigneeEmail", "teamName", "phaseId", "statusId", "badges"],
    sample: [
      "projectKey,title,description,priority,type,category,dueDate,estimatedHours,storyPoints,assigneeEmail,teamName,phaseId,statusId,badges",
      "NETIQ,Setup BGP routing,Configure BGP sessions,HIGH,TASK,INFRA,2025-07-01T00:00:00Z,8,5,telco.lead@avendum.tech,Telco Team,,",
      "DEVOPS,CI pipeline setup,GitHub Actions workflow,MEDIUM,TASK,BACKEND,2025-07-15T00:00:00Z,16,8,dev.lead@avendum.tech,Dev Team,,,MILESTONE",
      "NETIQ,Customer portal UI,Frontend dashboard design,LOW,TASK,FRONTEND,2025-07-30T00:00:00Z,24,13,dev.member@avendum.tech,Dev Team,,,",
    ].join("\n"),
