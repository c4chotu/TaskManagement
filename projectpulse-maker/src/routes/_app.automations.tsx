...
import { useAutomations, useDepartments, useRoutingRules, useCreateRoutingRule, useUpdateRoutingRule } from "@/lib/queries";
...
function CreateRuleDialog({ depts }: { depts: any[] }) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Configure criteria to automatically assign new tasks or incidents.</DialogDescription>
        </DialogHeader>

        <div className="space-y-4 py-2">
          <div className="space-y-1.5">
            <Label>Rule Name</Label>
            <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Critical Incident SRE Router" />
          </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleCreate} className="bg-gradient-primary text-primary-foreground">Create Rule</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
