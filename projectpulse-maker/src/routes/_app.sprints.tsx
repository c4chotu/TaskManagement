              ...
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border bg-gradient-to-r from-primary/10 to-card px-4 py-3">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className={`text-[10px] ${sp.status === "ACTIVE" ? "border-primary/40 text-primary" : sp.status === "COMPLETED" ? "border-muted-foreground/40 text-muted-foreground" : ""}`}
                    >
                      {sp.status}
                    </Badge>
                  </div>
                ...
                <span className="font-mono text-[10px] text-muted-foreground">
                  {format(new Date(sp.startDate), "MMM d")} →{" "}
                  {format(new Date(sp.endDate), "MMM d")}
                </span>
              </div>
